...
logger = logging.getLogger("ELMoGRU")


class ELMoGRU(BaseModel):
    predictions = list()
    ...
    def train(self):
        logger.info("Training ELMoGRU model...")
        ...
        def evaluate_voting():
            logger.info("Evaluating the voting of 9 models with individual accuracies " + str(get_voting_individual_accuracies()))
